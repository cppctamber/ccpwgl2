// BACKUP - the untouched pre-2026 ccpwgl EvePlanet, kept verbatim except for
// its class name and registration.
//
// NOT A CARBON PORT. Carbon`s EvePlanet (trinity/trinity/Eve/EvePlanet.h)
...
// its own name so it cannot answer for `EvePlanet` in the black reader.
...
export class EveOldPlanet extends EveObject
{
    ...
    @meta.uint
    resolution=EveOldPlanet.DEFAULT_HEIGHT_MAP_RESOLUTION;
     ...
     * @return {Promise<EveOldPlanet|null>}
     */
    async Rebuild()
    {
