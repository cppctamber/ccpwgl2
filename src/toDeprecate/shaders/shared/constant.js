...
export const G_PIXEL_ADJUSTMENT = {
    name: "g_pixel_adjustment",
    value: [ 0.05, 1, 1, 1 ],
    isAutoregister: 1,
    ui: {
        group: "Pixel",
        description: "Pixel Adjustments",
        components: [
            "contrast",
            "gamma", // not supported yet
            "lift", // not supported yet
            "gain" // not supported yet
        ],
