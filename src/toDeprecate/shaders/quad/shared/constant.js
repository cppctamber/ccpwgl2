...
export const P3DiffuseColor = createLinearColor({
    name: "P3DiffuseColor",
    ui: {
        group: "Material P3",
...
export const P3FresnelColor = createLinearColor({
    name: "P3FresnelColor",
    ui: {
        group: "Material P3",
        description: "albedo color"
...
export const P3Gloss = createGloss({
    name: "Mtl1Gloss",
    ui: {
        group: "Material P3",
        description: "gloss"
...
export const P3DustDiffuseColor = createLinearColor({
    name: "P3DustDiffuseColor",
    ui: {
        group: "Material P3",
...
export const P3MaterialData = {
    name: "PMtl1PatternMode",
    value: [ 1,1,1,0 ],
    ui: {
        group: "Material P3",
        widget: WidgetType.MIXED,
        description: "Controls the p3 material overrides",
        components: [
            "enabled",
            "maskPMtl1",
            "maskPMtl2"
...
export const PMtl1PatternMode = {
    ...
    ui: {
        ...
        description: "Pattern 1 controls",
        display: 1
    }
};

export const PMtl1PatternBlur = {
    name: "PMtl1PatternBlur",
    value: [ 1,1,0,0 ],
    ui: {
        group: "Pattern Material 1",
        widget: WidgetType.MIXED,
        ...
        description: "Pattern 1 blur direction",
        display: 1
    }
};

export const PMtl2PatternMode = {
    name: "PMtl2PatternMode",
    value: [ 1,1,1,0 ],
    ui: {
        ...
        description: "Pattern 2 controls",
        display: 1
    }
};

export const PMtl2PatternBlur = {
    name: "PMtl2PatternBlur",
    value: [ 1,1,0,0 ],
    ui: {
        group: "Pattern Material 2",
        widget: WidgetType.MIXED,
...
export const PMtlPatternModes = {
    name: "PMtlPatternModes",
    value: [ 0,0,0,0 ],
    ui: {
        group: "Pattern",
        widget: WidgetType.MIXED,
        ...
        description: "Pattern blend modes"
    }
};

export const PatternBlendMode = {
    "NONE" : 0,
    "ADD" : 1,
    "SUBTRACT": 2,
    "MULTIPLY" : 3,
