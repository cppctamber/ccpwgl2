...
import { quadUtilityDetailV5, skinnedQuadUtilityDetailV5 } from "./extended/quadUtilityDetailV5";
...
export const quadDetailV5 = {
    ...
    techniques: {
        ...
        //Utility: quadUtilityDetailV5.techniques.Main,
            ...
            ps: {
                ...
                shader: `
                    ...
                    void main()
                    {
                        ...
                        // PatternMask1Map
                        r10=cjsAddressed(s9,v6.xy, cb8[9].xy, c27.wwww);

                        // PatternMask2Map
                        r12=cjsAddressed(s10,v6.zw, cb8[10].xy, c27.wwww);

                        r10=r10.xxxx*cb4[12];
                        r12=r12.xxxx*cb4[13];
                        applyCustomMaskBlendMode(r10, r12);
...
export const skinnedQuadDetailV5 = {
    ...
    techniques: {
        ...
        //Utility: skinnedQuadUtilityDetailV5.techniques.Main,
