            ...
            ps: {
                ...
                shader: `
                    ...
                    void main()
                    {
                        ...
                        // Custom
                        // c37.xyz Dirt Fresnel color
                        vec4 c37=vec4(0.019,0.017,0.014,1.0);
                        // c38.xyz Dirt albedo color
                        vec4 c38=vec4(0.13,0.09,0.1,0.0);
                        ...
                        vec4  dirtDetail=vec4(0.5)+texture2D(s12,v0.xy*20.0);
                        vec3  albedo=texture2D(s2,v0.xy).xyz;
                        vec3  dirtAlbedoColor=c38.xyz*albedo*dirtDetail.x;
