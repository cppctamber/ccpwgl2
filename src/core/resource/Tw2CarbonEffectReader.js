...
export class Tw2CarbonShaderFactory
{
    ...
    _createPass(group, path)
    {
        ...
        // The `carbonRenderStates` setting "all" lifts the allowlist for A/B testing.
        if (tw2.settings.GetValue("carbonRenderStates") === "all" || this.constructor.RENDER_STATE_PATHS.some(part => path.includes(part)))
        {
